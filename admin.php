...
<head>
    ...
    <title>Administrador | Constancias</title>
                ...
                <div class="box box-border">
                    <div class="box-body">
                        <center>
                            ...
                            <h4 style="font-family: Nunito, sans-serif;">ADMINISTRADOR CONSTANCIAS</h4>
                        </center><br>
                ...
                <div class="box box-border">
                    <div class="box-body">
                        ...
                        <form method="post" action="admin.php?rp=2" enctype="multipart/form-data">
                            ...
                            <a class="btn btn-primary" onclick="window.location=' . "'" . '/constancias/admin.php' . "'" . '">Regresar</a>
                        </form>
                    </div>
                </div>
            </div>
